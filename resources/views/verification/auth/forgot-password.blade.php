...
<x-head title="Lupa Password - Jurnal Magang SMK Islamic Centre Baiturrahman" />
                    ...
                    <div class="mb-5">
                        ...
                        @if (session('status'))
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Permintaan Berhasil</strong>&nbsp;Silahkan cek email, untuk melakukan reset.
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                        @endif
                        <h3 class="fw-bold">Forgot Password</h3>
                        <p class="text-secondary">Lupa akun Jurnal Magang</p>
                        <form action="{{ route('password.request') }}" method="post">
                            @csrf
                            <div class="form-floating mb-3">
                                <input type="email" name="email" class="form-control form-control-lg fs-6"
                                    placeholder="Masukkan Email" id="floatingInput" required>
